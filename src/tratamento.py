...
def carregar_e_tratar():
    ...
    df["preco_desconto"] = (
        df["preco_desconto"].str.replace("₹", "").str.replace(",", "").astype(float)
    )
    ...
    df["perc_desconto"] = df["perc_desconto"].str.replace("%", "").astype(float)

    # remover vírgula da quantidade de avaliações
    df["qtd_avaliacoes"] = df["qtd_avaliacoes"].str.replace(",", "").astype(float)
    ...
    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains(
            "Cable|Cabo|Braided|Type-C|Lightning", case=False, na=False
        ),
        "tipo_produto",
    ] = "cabo"
    ...
    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains(
            "Headphone|Earphone|Headset|Earbuds", case=False, na=False
        ),
        "tipo_produto",
    ] = "fone"
    ...
    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains("Speaker|Soundbar", case=False, na=False),
        "tipo_produto",
    ] = "caixa de som"

    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains("Mouse|Keyboard|Webcam", case=False, na=False),
        "tipo_produto",
    ] = "periferico"

    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains("Bag|Case|Cover|Pouch", case=False, na=False),
        "tipo_produto",
    ] = "bolsa/acessorio"

    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains("TV|Television|Smart TV", case=False, na=False),
        "tipo_produto",
    ] = "tv"
    ...
    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains(
            "Phone|Smartphone|Mobile|iPhone|Android", case=False, na=False
        ),
        "tipo_produto",
    ] = "celular"
    ...
    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains(
            "Controller|Gamepad|Joystick", case=False, na=False
        ),
        "tipo_produto",
    ] = "controle"
    ...
    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains(
            "Laptop|Computer|PC|Notebook", case=False, na=False
        ),
        "tipo_produto",
    ] = "computador"
    ...
    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains("Router|WiFi|Adapter|Modem", case=False, na=False),
        "tipo_produto",
    ] = "rede"

    df.loc[
        (df["tipo_produto"] == "outros")
        & df["produto"].str.contains("Charger|Charging|Adapter", case=False, na=False),
        "tipo_produto",
    ] = "carregador"
